...
const FamilyCenter = () => {
  const [messages] = useState([
    { 
      id: 1, 
      content: "Request for leave due to general health check-up on May 3, 2025",
      status: "approved",
      date: "2025-04-30"
    },
    { 
      id: 2, 
      content: "Follow-up on vaccination schedule confirmed by Dr. Ajay",
      status: "pending",
      date: "2025-04-28"
    },
    { 
      id: 3, 
      content: "Request for postponing annual medical exam by parent - declined",
      status: "rejected",
      date: "2025-04-25"
    }
  ]);
