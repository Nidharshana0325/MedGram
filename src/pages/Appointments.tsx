...
export default function Appointments() {
  ...
  const doctors = [
    { id: 1, name: 'Dr. Anjali Verma', specialty: 'General Physician' },
    { id: 2, name: 'Dr. Ramesh Iyer', specialty: 'Dermatologist' },
    { id: 3, name: 'Dr. Priya Mehta', specialty: 'Pediatrician' },
    { id: 4, name: 'Dr. Neha Singh', specialty: 'Dentist' },
    { id: 5, name: 'Dr. Vikram Sharma', specialty: 'Cardiologist' },
  ];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    updatedAppointments.sort((a, b) => new Date(a.date).getTime() - new Date(b.date).getTime());
