...
export default function Dashboard() {
  ...
  // Indian student details (localized)
  const userDetails = {
    StudentName: "Lokaesshwar",
    StudentId: "VITBPL-2022-CS-22BHI10102",
    University: "VIT Bhopal University",
    ParentPhone: "+91 98765 43210",
    MedicalHistorySummary: "No major illnesses. Allergic to dust and peanuts.",
  };
  ...
  const recentRecords = [
    { id: 1, date: "2025-03-14", doctorName: "Dr. Anjali Sharma", diagnosis: "General Checkup", fileUrl: "https://example.com/medical-record-1.pdf" },
    { id: 2, date: "2025-03-10", doctorName: "Dr. Rajeev Reddy", diagnosis: "Seasonal Allergy", fileUrl: "https://example.com/medical-record-2.pdf" },
  ];

  const upcomingAppointments = [
    { id: 1, date: "2025-03-20", time: "10:00 AM", doctorName: "Dr. Meera Iyer", type: "Routine Checkup" },
    { id: 2, date: "2025-03-25", time: "2:30 PM", doctorName: "Dr. Arjun Nair", type: "Follow-up" },
  ];
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold text-gray-900">
          Welcome back{user?.full_name ? `, ${user.full_name}` : ", Lokeshwar"}!
        </h1>
