...
export default function Documents() {
  ...
  // Initial document list (this will be dynamically updated)
  const [documents, setDocuments] = useState([
    {
      ...
      fileUrl: '/documents/Medical_Certificate_Lokaesshwar.pdf', // Relative path
    },
    {
      id: 2,
      type: 'Health Record',
    ...
    },
    {
      ...
      fileUrl: '/documents/Prescription_Lokaesshwar.pdf', // Relative path
    },
  ]);
  ...
  const handleSubmit = (e: SubmitEvent): void => {
    ...
    const newDocument: NewDocument = {
      ...
      status: 'processing', // Initially mark as processing
      description: reason,
      fileUrl: undefined, // Initially no file URL
    };
  ...
  // Handle file download (if file URL is available)
  interface Document {
    id: number;
    type: string;
    date: string;
  ...
  const handleDownload = (fileUrl: string | undefined): void => {
    if (fileUrl) {
